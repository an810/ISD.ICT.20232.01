...
public class Config {
    ...
    private static final String vnp_ReturnUrl = "http://localhost:8080/payment";
    private static final String vnp_TmnCode = "3EBUDP0P";
    private static final String secretKey = "V4S3JKIW9JF4CEF0L1SRXH2W4SLMK8B6";
